		...
		<div className="container pb-100">
			...
			<div className="team-details__bottom pt-100">
				<div className="row">
					...
					<div className="col-xl-6 col-lg-6">
						<div className="team-details__bottom-right skills">
                            <div className="skill-item">
                                <div className="skill-header">
                                    <h6 className="skill-title">Tecnology</h6>
                                </div>
                                {/* progress bar */}
                                <div className="skill-bar">
                                    ...
                                    <div className="bar progress-line" style={{width:"92%"}}>
                                        ...
                                        <div className="count-box"><span className="count-text"><CounterUp count={92} time={3} /></span>%</div>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <div className="skill-item">
                                ...
                                <div className="skill-bar">
                                    <div className="bar-inner">
                                    <div className="bar progress-line" style={{width:"56%"}}>
                                        <div className="skill-percentage">
                                        <div className="count-box"><span className="count-text"><CounterUp count={56} time={3} /></span>%</div>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <div className="skill-item">
                                ...
                                <div className="skill-bar">
                                    <div className="bar-inner">
                                    <div className="bar progress-line" style={{width:"40%"}}>
                                        <div className="skill-percentage">
                                        <div className="count-box"><span className="count-text"><CounterUp count={40} time={3} /></span>%</div>
                                        </div>
                                    </div>
                                    </div>
                                </div>
