...
export default function Bengalroom() {
  return (
    <>
            ...
            <div className="col-xl-8 col-lg-7">
              ...
              <div className="room-details__left">
                <div className="wrapper">
                  ...
                  <p className="text">It is at the eastern end of gangetic plains the apex of the bay of bengal kolkata the capital of west bengal</p>
