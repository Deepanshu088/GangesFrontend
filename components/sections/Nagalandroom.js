...
export default function nagalandroom() {
  return (
    <>
            ...
            <div className="col-xl-8 col-lg-7">
              ...
              <div className="room-details__left">
                <div className="wrapper">
                  ...
                  <p className="text">It's home to diverse indigenous tribes, with festivals and markets celebrating the different tribes' culture</p>
