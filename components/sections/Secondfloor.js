  ...
  return (
    ...
    <div className="room-block col-lg-6 col-md-6 col-sm-15">
      <div className="inner-box wow fadeIn">
        ...
        <h6 className="title" style={{ marginRight: '30px' }}><Link href="/page-colonialroom">Colonial Room</Link></h6>
    ...
    <div className="room-block col-lg-6 col-md-6 col-sm-15">
      <div className="inner-box wow fadeIn">
        ...
        <div className="content-box">
          <h6 className="title" style={{ marginRight: '30px' }}><Link href="/page-tamilnadu">Tamil nadu Room</Link></h6>
          <span className="price" style={{ marginRight: '30px' }}>₹10000  / NIGHT</span>
        </div>
        <div className="box-caption">
        <Link href="/room-details" title="" className="book-btn" style={{ fontSize: '12px' }}>book now</Link>
    ...
    <div className="room-block col-lg-6 col-md-6 col-sm-15">
      <div className="inner-box wow fadeIn">
        ...
        <div className="content-box">
          <h6 className="title" style={{ marginRight: '30px' }}><Link href="/page-orissaroom">Orissa Room</Link></h6>
          <span className="price" style={{ marginRight: '30px' }}>₹10000  / NIGHT</span>
        </div>
        <div className="box-caption">
        <Link href="/room-details" title="" className="book-btn" style={{ fontSize: '12px' }}>book now</Link>
    ...
    <div className="room-block col-lg-6 col-md-6 col-sm-12">
      <div className="inner-box wow fadeIn">
        ...
        <div className="content-box">
          <h6 className="title" style={{ marginRight: '30px' }}><Link href="/page-assam">Assam Room</Link></h6>
          <span className="price" style={{ marginRight: '30px' }}>₹10000  / NIGHT</span>
        </div>
        <div className="box-caption">
        <Link href="/room-details" title="" className="book-btn" style={{ fontSize: '12px' }}>book now</Link>
    ...
    <div className="room-block col-lg-6 col-md-6 col-sm-12">
      <div className="inner-box wow fadeIn">
        ...
        <div className="content-box">
          <h6 className="title" style={{ marginRight: '30px' }}><Link href="/page-kerala">Kerala Room</Link></h6>
          <span className="price" style={{ marginRight: '30px' }}>₹10000  / NIGHT</span>
        </div>
        <div className="box-caption">
        <Link href="/room-details" title="" className="book-btn" style={{ fontSize: '12px' }}>book now</Link>
    ...
    <div className="room-block col-lg-6 col-md-6 col-sm-12">
      <div className="inner-box wow fadeIn" data-wow-delay="200ms">
        ...
        <div className="content-box">
          <h6 className="title" style={{ marginRight: '30px' }}><Link href="/page-jodhpur">Jodhpur Room</Link></h6>
          <span className="price" style={{ marginRight: '30px' }}>₹10000  / NIGHT</span>
        </div>
        <div className="box-caption">
        <Link href="/room-details" title="" className="book-btn" style={{ fontSize: '12px' }}>book now</Link>
    ...
    <div className="room-block col-lg-6 col-md-6 col-sm-12">
      <div className="inner-box wow fadeIn" data-wow-delay="200ms">
        ...
        <div className="content-box">
          <h6 className="title" style={{ marginRight: '30px' }}><Link href="/page-gujarat">Gujarat Room</Link></h6>
          <span className="price" style={{ marginRight: '30px' }}>₹10000  / NIGHT</span>
        </div>
        <div className="box-caption">
        <Link href="/room-details" title="" className="book-btn" style={{ fontSize: '12px' }}>book now</Link>
    ...
    <div className="room-block col-lg-6 col-md-6 col-sm-12">
      <div className="inner-box wow fadeIn" data-wow-delay="200ms">
        ...
        <div className="content-box">
          <h6 className="title" style={{ marginRight: '30px' }}><Link href="/page-punjab">Punjab Room</Link></h6>
          <span className="price" style={{ marginRight: '30px' }}>₹10000  / NIGHT</span>
        </div>
        <div className="box-caption">
        <Link href="/room-details" title="" className="book-btn" style={{ fontSize: '12px' }}>book now</Link>
