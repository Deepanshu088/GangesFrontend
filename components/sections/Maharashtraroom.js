...
export default function maharashtharoom() {
  return (
    <>
            ...
            <div className="col-xl-8 col-lg-7">
              ...
              <div className="room-details__left">
                <div className="wrapper">
                  ...
                  <p className="text">The third largest state of india,Maharashtra occupies a significant portion of the deccan plateau</p>
