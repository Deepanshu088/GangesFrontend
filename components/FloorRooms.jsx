...
const FloorRooms = ({floor}) => {
    ...
    return <div className="room-container" style={{ marginTop: '80px', marginLeft: '50px', marginRight: '50px' }}>
                    ...
                    <div className="room-block col-lg-6 col-md-6 col-sm-15">
                        <div className="inner-box wow fadeIn">
                            <div className="image-box">
                                <figure class="image-2 overlay-anim"><img src={item.coverPhoto} alt="" className="md:h-[50vh] w-full object-cover" /></figure>
                            </div>
